...
public class Runner {
    ...
    /*
        ...
        @CucumberOptions ise framework umuzda gerekli ayarlari yapar
        ...
        glue : feature dosyalari ile bagli olan
                ...
                tum classlari iceren package in adresini yazariz.
                boylece ilgili step hangi class altında oluesa olsun
                cucumber bulup calistirir

        tags :  calistirilacak Feature veya Scenerio(lari) isaretlemek
                icin kullanilir. Cucumber Runner Class i calistirildiginda
         ...
         dryRun : Bir feature dosyasini ilk defa yazdigimizda
                steplerden bazilari daha once var oldugundan BEYAZ
                bazilari ise ilk defa kullanacagimiz icin SARI olur.

                Bir Feature dosyasini direk calistirmak istersek
                Bastan vaslayarak beyaz olan adimlari calistirir,
